...
- [Xquik-dev/x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) - 开源 Agent Skill；通过闭源托管的 Xquik REST API 或 MCP 做有边界的 X 数据研究。
...
## Star History
  [查看仓库 Star 历史。](https://www.star-history.com/#LLMQuant/awesome-trading-agents&Date)
