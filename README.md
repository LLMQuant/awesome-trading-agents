...
- [thebrierfox/the-stall](https://github.com/thebrierfox/the-stall) - Remote pay-per-call MCP with 173 tools via x402 on Base mainnet; US stocks, crypto/DeFi, options chains, macro indicators, sanctions screening, Polymarket/Limitless prediction markets, Reddit search, and 160+ more. No self-hosting or API keys — agents pay USDC per call at the live endpoint.
